...
from schemas.task_record import TaskActionData, TaskRecordData
from services.task_admin_service import cancel_document_index_task, retry_document_index_task
...
async def get_task_status(
    ...
    if task.task_type == "document_index":
        ...
        if not document:
            raise BusinessException(message="你无权查看该任务", code=4007, status_code=403)
