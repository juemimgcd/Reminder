...
from services.memory_agent.eval.contracts import Citation, EvalCase, EvaluationReport, Evidence
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--live-endpoint", help="opt-in Memory Agent base URL for live predictions")
    parser.add_argument(
        "--service-token-env",
