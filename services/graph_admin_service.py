...
from clients.neo4j_client import is_neo4j_projection_enabled, probe_neo4j
...
from services.graph_projection_service import (
...
async def rebuild_graph_projection_for_user(
    ...
    if not is_neo4j_projection_enabled():
        raise BusinessException(message="Neo4j 图投影未启用", code=5031, status_code=503)
