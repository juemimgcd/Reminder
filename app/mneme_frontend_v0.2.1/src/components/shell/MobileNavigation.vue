...
<style scoped>
.mobile-navigation { position: fixed; inset: auto 0 0; z-index: 35; display: none; min-height: 3.7rem; grid-template-columns: repeat(6, minmax(0, 1fr)); padding: 0.3rem max(0.35rem, env(safe-area-inset-right)) max(0.35rem, env(safe-area-inset-bottom)); background: color-mix(in srgb, var(--bg-sidebar) 96%, transparent); border-top: 1px solid var(--border-muted); }
