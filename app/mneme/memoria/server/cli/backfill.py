...
from app.mneme.memoria.server.database import engine, open_read_session
...
from app.mneme.memoria.server.repositories.projections import projection_batch_payload_hash
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Report rebuildable Memoria projection state without mutating it."
    )
