...
from app.mneme.memoria.configuration.schemas import (
...
from app.mneme.memoria.configuration.service import (
...
async def delete_ai_model_config_api(
    ...
    return success_response(
        data={"config_id": config_id, "deleted_count": deleted_count},
