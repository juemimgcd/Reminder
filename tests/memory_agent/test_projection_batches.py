...
from services.memory_agent.repositories.projections import ProjectionIntegrityError
from services.memory_agent.services.projections import IncompleteProjectionError, _prepare_projection
