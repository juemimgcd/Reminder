...
from services.memory_agent.cli.backfill import _aggregate_hash, _raw_chunk_map
...
def test_backfill_supports_resume_filters_and_reports_dry_run_without_writes():
    source = Path("services/memory_agent/cli/backfill.py").read_text(encoding="utf-8")
