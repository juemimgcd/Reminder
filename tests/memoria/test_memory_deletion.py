...
def test_deletion_recalculates_supported_memory_and_never_copies_source_content_to_audit():
    source = Path("app/mneme/memoria/server/services/deletion.py").read_text(encoding="utf-8")
    commands = Path("app/mneme/memoria/server/services/memory_commands.py").read_text(encoding="utf-8")
